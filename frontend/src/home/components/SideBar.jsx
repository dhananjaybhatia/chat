...
//     if (!clickedUser.some((selected) => selected._id === user._id)) {
//       setClickedUser((prev) => [...prev, user]); // Add the user to the selected users list
//     }
//     // dispatch(setSelectedUser(user));
//     setFoundUser([]); // Clear the list of found users
...
//             <div
//               key={user._id}
//               className="flex items-center gap-3 p-4 bg-yellow-200 rounded-2xl mb-3"
//             >
//               <img
//                 src={user.profilePic || "https://via.placeholder.com/150"}
//                 alt={user.fullName.firstName}
...
//       {/* Display chat users or "Let us find someone to talk.." message */}
//       {foundUser.length === 0 && clickedUser.length === 0 && (
...
//                 >
//                   <img
//                     src={elem.profilePic || "https://via.placeholder.com/150"}
//                     alt={elem.fullName.firstName}
//                     className="h-10 w-10 rounded-full"
//                   />
//                   <div className="flex flex-col">
//                     <span className="text-lg">
//                       {elem.fullName.firstName} {elem.fullName.lastName}
//                     </span>
